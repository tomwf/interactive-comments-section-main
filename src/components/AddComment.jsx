...
const AddComment = ({ setComment, handleSubmit }) => {
  return (
    <form className='grid grid-rows-[1fr_auto] grid-cols-2 sm:grid-rows-none sm:grid-cols-[auto_1fr_auto] items-center sm:items-start bg-white rounded-lg p-5 min-h-[200px] w-full gap-5'>
      ...
      <button className='justify-self-end col-span-1 sm:col-start-3 sm:col-end-4 bg-moderateBlue px-6 py-3 rounded-lg text-white font-bold' onClick={handleSubmit}>SEND</button>
    </form>
  )
}
