      ...
      <div className='grid grid-cols-2 sm:grid-cols-[auto_1fr_auto] sm:gap-x-7 bg-white p-5 rounded-lg'>
        ...
        <div className='sm:col-start-1 sm:col-end-2 sm:row-start-1 sm:row-end-3 flex flex-row sm:flex-col self-start justify-self-start sm:w-11 bg-lightGray rounded-lg'>
          <button className='grid place-content-center p-3' onClick={() => increaseScore(id, parentId)}>
            <img className='w-4 h-4 object-contain' src='./images/icon-plus.svg' alt='reply icon' />
          </button>
          ...
          <button className='grid place-content-center p-3' onClick={() => decreaseScore(id, parentId)}>
            <img className='w-4 h-4 object-contain' src='./images/icon-minus.svg' alt='reply icon' />
          </button>
        </div>
        {name === 'juliusomo'
          ? <div className='flex gap-3'>
            <button className='sm:col-start-3 sm:col-end-4 sm:row-start-1 sm:row-end-2 justify-self-end col-start-2 col-end-2 flex items-center gap-2.5 font-bold text-softRed' onClick={() => deleteReply(parentId, id)}>
